      ...
      <main>
        <table>
         ...
         ${orders.map((ord) => {
            return (
                `   <tr>
                <td class="service">${ord.name}</td>
                <td class="desc">${ord.phone}</td>
                <td class="desc">${ord.location}</td>
                <td class="desc">${ord.amount}</td>
                <td class="unit">${ord.date}</td>
                <td class="desc">${ord.storeName}</td>
                <td class="unit">${ord.deliveryPersonName}</td>
