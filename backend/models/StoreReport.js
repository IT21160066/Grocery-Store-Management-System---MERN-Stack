      ...
      <main>
        <table>
         ...
         ${store.map((st) => {
            return (
                `   <tr>
                <td class="service">${st.userName}</td>
                <td class="desc">${st.name}</td>
                <td class="desc">${st.nic}</td>
                <td class="desc">${st.phoneNo}</td>
                <td class="unit">${st.addressNo}</td>
                <td class="unit">${st.street}</td>
                <td class="desc">${st.city}</td>
                <td class="desc">${st.postalCode}</td>
                <td class="desc">${st.email}</td>
