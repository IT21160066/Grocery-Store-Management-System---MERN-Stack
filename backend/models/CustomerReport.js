module.exports = (stoks) => {
    const today = new Date()
    console.log('data passed')
    console.log(stoks)
    console.log("inside the pdf  stock model ")
    ...
    return `
        ...
        <div id="project">
          <div><span>Position</span>Customer Manager</div>
      ...
      <main>
        <table>
         ...
         ${stoks.map((cus) => {
            return (`
                <tr>
                    <td class="service">${cus.userName}</td>
                    <td class="desc">${cus.name}</td>
                    <td class="desc">${cus.email}</td>
                    <td class="desc">${cus.address}</td>
                    <td class="unit">${cus.phoneNo}</td>
                </tr> `
            )
         })}  
          </tbody>
