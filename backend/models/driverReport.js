module.exports = (Employees) => {
    ...
    return `
        ...
        <div id="company" class="clearfix">
          ...
          <div>Sri Lanka<br /> No:269/A, Kandy Road</div>
          <div>04122#####</div>
      ...
      <main>
        <table>
         ...
         ${Employees.map((emp) => {
            return (
                `   <tr>
                <td class="service">${emp.userName}</td>
                <td class="desc">${emp.name}</td>
                <td class="desc">${emp.nic}</td>
                <td class="desc">${emp.phoneNo}</td>
                <td class="unit">${emp.addressNo}</td>
                <td class="unit">${emp.street}</td>
                <td class="unit">${emp.city}</td>
                <td class="unit">${emp.postalCode}</td>
                <td class="unit">${emp.email}</td>
