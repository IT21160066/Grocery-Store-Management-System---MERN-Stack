      ...
      <main>
        <table>
         ...
         ${sales.map((sup) => {
            return (
                `   <tr>
                <td class="service">${sup.itemname}</td>
                <td class="desc">${sup.supplierId}</td>
                <td class="desc">${sup.saleDate}</td>
                <td class="desc">${sup.description}</td>
                <td class="unit">${sup.quantity}</td>
                <td class="unit">${sup.amount}</td>
